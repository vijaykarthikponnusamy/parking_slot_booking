				 ...
				 <?php
  			   	  ...
  			   	  <h3>View Booking</h3>
						 ...
						 <td><?php echo $row["cut_time"] * $row["amt"]; ?></td>
	                                         <td><?php if($row['amt_status'] == ""){ if($row['slot_type'] == "paid"){ ?> <button type="button" class="btn btn-success" data-toggle="modal" data-target="#addMoney<?php echo $row['id']; ?>">Pay Now</button> <?php }}else{ echo "<b class='text-danger'>PAID</b>"; } ?> </td>
	                                        </tr>

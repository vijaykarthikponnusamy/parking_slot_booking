		...
		<form name="custregForm" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
		  ...
		  <div class="form-row">
                    <div class="form-group col-md-6">
                      ...
                      <input type="email" class="form-control" id="custregEmail" name="custregEmail" placeholder="Enter the valid email id..." required value="<?php echo $row['email']; ?>">
                    </div>
                    <div class="form-group col-md-6">
                      <label for="inputPassword4">Mobile No.</label>
                      <input type="number" class="form-control" id="custregMNo" name="custregMNo" placeholder="Enter the valid mobile no..." required value="<?php echo $row['mno']; ?>">
                    </div>
                  </div>
		  <div class="form-row">
                    <div class="form-group col-md-6">
		  ...
		  <div class="form-row">
			...
			<?php
				...
				<img src="uploads/<?php echo $row['attach']; ?>" width="120">
				<?php
				}
			?>
		    </div>
